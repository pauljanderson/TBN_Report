...
rem Mag9 = Mag10 minus AMD (AMD intentionally out of WPBR DailyRun / ongoing reconcile).
if not defined WPBR_SYMBOLS set "WPBR_SYMBOLS=AAPL,AMZN,AU,META,MSFT,NVDA,NFLX,GOOGL,TSLA"
