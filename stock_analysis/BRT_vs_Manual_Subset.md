...
**BRT file:** ..\Drive\BRT_Closed_260302095839.csv
...
| Group | Count |
|-------|-------|
| Matched (fuzzy or exact) | 18 |
| - Exact match (same entry date) | 0 |
| - Fuzzy match (entry date off 1-2 days) | 18 |
| - Matched but with price/other differences | 4 |
| - Matched, no material difference | 14 |
| BRT only (symbols in manual list) | 5 |
| Manual only | 4 |
...
- **TSLA** BRT entry 20230725 / manual entry 20230724
  - exit_price: BRT=235.7 manual=237.35
  - profit_pct: BRT=-13.47% manual=-12.86%
  - entry_date: BRT=20230725 manual=20230724 (next-open convention)
...
*14 trades* (entry date may differ by 1-2 days; prices/exit align)
