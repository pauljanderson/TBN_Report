...
if not defined BRT_SYMBOLS set "BRT_SYMBOLS=AAPL,ABBV,ACN,ADBE,ADI,AMAT,AMD,AMZN,AU,AVGO,BABA,BAC,CDNS,CF,CI,CRM,CRWD,EVR,GOOG,GOOGL,HD,JPM,KR,LYV,META,MPC,MSFT,MU,NEM,NFLX,NTAP,NVDA,ORCL,PFE,PG,PPTA,SHOP,TMUS,TSLA,TSM,UNH,V,WFC,WMT,XOM"
