#!/usr/bin/env python3
"""GOOGL-only reconcile vs startfloor halfup stamp 260722165827."""
...
def main() -> int:
    ...
    lines.append(
        ...
        f"(`_tmp_googl_startfloor_reconcile.py` / min_pivot_date={MIN_DATE}).*"
    )
    lines.append("")
    ...
    print("=== GOOGL startfloor reconcile ===")
