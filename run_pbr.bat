...
rem Standalone: double-click or call from DailyRun. Override: set PBR_SYMBOLS=SYM1,SYM2 before calling.
setlocal EnableExtensions
cd /d "%~dp0"
if not defined PY call "%~dp0resolve_python.bat"
if errorlevel 1 exit /b 1

if not defined PBR_SYMBOLS set "PBR_SYMBOLS=AMZN,AMD,AU,GOOGL,META,TSLA"
