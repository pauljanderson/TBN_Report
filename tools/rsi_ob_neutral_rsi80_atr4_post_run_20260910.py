#!/usr/bin/env python3
"""Post-run (no charts, no Yahoo) on rsi80+atr4 CONTROL Closed book."""
...
def _prepend_ask(path: Path) -> None:
    ...
    block = (
        ...
        "control = prior lean EXIT_rsi80 from "
        "<code>rsi_ob_neutral_rsi75_atr4_20260910</code> (on top of rsi75+atr4), "
