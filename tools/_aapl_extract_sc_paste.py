#!/usr/bin/env python3
"""Extract latest AAPL WPBR breakout+trade paste; keep existing OHLC/weekly."""
...
OUT = REPO / "drive" / "wpbr_sheet_reconcile" / "AAPL"
...
for i, ln in enumerate(lines):
    if '"role":"user"' not in ln:
        continue
    has_marker = (
        "28.52\\t28.52\\t27.68" in ln
        or "28.52\t28.52\t27.68" in ln
        or "9/13/2016\\t$26.88" in ln
        or "9/13/2016\t$26.88" in ln
    )
...
assert candidates, "no AAPL paste found"
...
print("indices zones/trades:", i_zones, i_trades)
