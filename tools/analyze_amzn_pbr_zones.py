#!/usr/bin/env python3
"""Forensics: AMZN PBR engine zones vs spreadsheet ground truth."""
...
from pbr_zones import aggregate_weekly, compute_pbr_touch_stream, _weekly_pivot_indices
...
def main() -> int:
    ...
    out = filter_pbr_output_for_compare(
        compute_pbr_touch_stream(df, band_pct=0.015, breakout_confirmation=0.03),
        df,
        min_date=SHEET_COMPARE_MIN_DATE,
    )
    gt = load_pbr_ground_truth()["AMZN"]
    sheet = gt.zones
