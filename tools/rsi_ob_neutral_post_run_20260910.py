#!/usr/bin/env python3
"""Post-run (no charts, no Yahoo) on the RSIN full-universe Closed book."""
...
OUT = ROOT / "drive" / "paul_experiments" / "rsi_ob_to_neutral_exit_ob_20260910"
...
LAYMAN = (
    "This page is the usual after-the-run checkup on the full-universe "
    "“buy after too-hot cools to the middle, sell when too-hot again” book. "
    "It is research only. A/B tests and the correlation sheet are in the sibling "
    "tune stamp <code>rsi_ob_neutral_tune_ab_20260910</code>."
)
