#!/usr/bin/env python3
"""Enrich the RSI Neutral-after-OB full-universe Closed book + correlation.

Reads drive/paul_experiments/rsi_ob_to_neutral_exit_ob_20260910/closed_fulluniv.csv,
adds house trigger-time fields (ATR, SMA, 52w, rel vol, z-score, wicks, RSI path),
writes:
  drive/RSIN_LatestRun_Closed.csv
  drive/paul_experiments/rsi_ob_to_neutral_exit_ob_20260910/RSIN_Closed_20260910.csv
  RSIN_Summary_20260910.csv
  RSIN_Correlation_20260910.csv (+ pairs)
"""
...
STAMP_DIR = ROOT / "drive" / "paul_experiments" / "rsi_ob_to_neutral_exit_ob_20260910"
SRC = STAMP_DIR / "closed_fulluniv.csv"
OUT_CLOSED = STAMP_DIR / "RSIN_Closed_20260910.csv"
OUT_SUMMARY = STAMP_DIR / "RSIN_Summary_20260910.csv"
OUT_CORR = STAMP_DIR / "RSIN_Correlation_20260910.csv"
OUT_CORR_IS = STAMP_DIR / "RSIN_Correlation_IS_20260910.csv"
