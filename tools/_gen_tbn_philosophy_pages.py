...
<p>
  ...
  Production gold / DailyRun first; then research and parked.
...
<div class="grid">
  ...
  <a class="card" href="systems/mts.html"><span class="tag gold">Production</span><strong>MTS — STONK_DATA sheet-parity</strong><span class="blurb">MTS-tab BI first-touch (not the BRT retest pipeline).</span></a>
  ...
  <a class="card" href="systems/mvcp.html"><span class="tag parked">Parked</span><strong>MVCP — Minervini VCP</strong><span class="blurb">Volatility Contraction Pattern (VCP) sleeve parked from live allocation (2026-08-12).</span></a>
...
<div class="callout warn">
  Research pages (e.g. VZ) and parked notes (MVCP) are for process transparency — not live allocation advice.
</div>
