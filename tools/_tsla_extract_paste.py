#!/usr/bin/env python3
"""Extract TSLA WPBR user paste from parent transcript -> TSLA/ raw + section files."""
import json
...
# Prefer latest full TSLA WPBR paste (2016+ OHLC marker $15.3800).
target = None
target_i = None
for i, ln in enumerate(lines):
    if (
        ...
        and ("1/4/2016\\t$15.3800" in ln or "1/4/2016\t$15.3800" in ln)
    ):
        target = ln
        target_i = i

assert target, "no TSLA WPBR paste found"
